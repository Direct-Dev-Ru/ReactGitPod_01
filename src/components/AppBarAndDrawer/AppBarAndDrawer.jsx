...
function ResponsiveDrawer(props) {
  ...
  /*
  Modifying the source code from the template example to use
  the react router pathname hook to set
    ...
    <div className={classes.root}>
      ...
      <AppBar position="sticky" className={isHome ? '' : classes.appBar}>
        <Toolbar>
          ...
          {/* <PalettePicker setCurrentTheme={setCurrentTheme} currentTheme={currentTheme} /> */}
